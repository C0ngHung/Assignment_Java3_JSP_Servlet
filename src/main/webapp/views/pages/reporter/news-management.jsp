        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div class="xl:col-span-1">
                <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 overflow-hidden sticky top-24">
                    ...
                    <!-- Form Content -->
                    <div class="p-6">
                        <form action="${pageContext.request.contextPath}/reporter/news-management" method="post" enctype="multipart/form-data" class="space-y-6">
                            <!-- ID (Hidden) -->
                            ...
                            <div class="space-y-2">
                                ...
                                <c:if test="${empty editNews or empty editNews.image}">
                                    <div id="uploadPlaceholder" class="group border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-indigo-400 hover:bg-gradient-to-br hover:from-indigo-50 hover:to-blue-50 transition-all duration-300 cursor-pointer">
                                        <label for="imageInput" class="cursor-pointer block">
                                            <div class="space-y-4">
                                    ...
                                    <div id="previewContainer" class="hidden w-full">
                                        <div class="relative overflow-hidden rounded-xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-green-50">
                                            <img id="imagePreview" src="#" alt="Ảnh xem trước" class="w-full h-48 object-cover"/>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <textarea name="content" rows="6" required
                                              ...
                                              placeholder="Nhập nội dung bài viết..."><c:out value="${editNews.content}"/></textarea>
                            ...
                            <div class="pt-6 border-t border-gray-200/60">
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <button type="button" name="action" value="reset"
                                            onclick="document.querySelector('form').reset(); document.getElementById('uploadPlaceholder').classList.remove('hidden'); document.getElementById('previewContainer').classList.add('hidden');"
                    ...
                    <div class="p-6">
                        <c:if test="${empty newsList}">
                            <div class="text-center py-20">
                                ...
                                <p class="text-gray-500 mb-6 max-w-sm mx-auto">Hãy tạo bài viết đầu tiên của bạn để bắt đầu chia sẻ những câu chuyện thú vị!</p>
                        ...
                        <c:if test="${not empty newsList}">
                            <div class="space-y-6">
                                <c:forEach var="news" items="${newsList}" varStatus="status">
                                    <article class="group bg-gradient-to-br from-white to-gray-50 border-2 border-gray-100 rounded-2xl p-6 hover:border-blue-200 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                                        ...
                                        <div class="flex gap-6 relative z-10">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-gray-600 text-sm leading-relaxed mb-4 line-clamp-2">
                                                    ${fn:substring(news.content, 0, 120)}<c:if test="${fn:length(news.content) > 120}">...</c:if>
                                                </p>
                                                ...
                                                <div class="flex justify-end">
                                                    <form action="${pageContext.request.contextPath}/reporter/news-management" method="post" class="inline">
