            ...
            <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 overflow-hidden sticky top-24">
                ...
                <div class="p-6">
                    <form action="${pageContext.request.contextPath}/admin/news-management" method="post"
                        ...
                        <!-- Ẩn Hiện Trang Chủ  -->
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-gray-700 flex items-center mb-1">
                                <svg class="w-4 h-4 mr-2 text-indigo-600" fill="none" stroke="currentColor"
                                     viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex items-center gap-8 mt-1">
                                <label class="inline-flex items-center cursor-pointer px-3 py-2 rounded-lg border border-gray-200 bg-white shadow-sm hover:border-blue-400 transition-all">
                                    <input type="radio" name="home"
                                           value="true" ${editNews.home == true ? "checked" : ""}
                                           class="form-radio text-blue-600 focus:ring-blue-500 h-5 w-5 border-gray-300">
                                    <span class="ml-2 text-blue-700 font-medium">Hiện</span>
                                </label>
                                <label class="inline-flex items-center cursor-pointer px-3 py-2 rounded-lg border border-gray-200 bg-white shadow-sm hover:border-gray-400 transition-all">
                                    <input type="radio" name="home"
                                           value="false" ${editNews.home == false ? "checked" : ""}
                                           class="form-radio text-gray-400 focus:ring-gray-500 h-5 w-5 border-gray-300">
                                    <span class="ml-2 text-gray-600 font-medium">Ẩn</span>
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div class="flex gap-6 relative z-10">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex justify-end">
                                                <form action="${pageContext.request.contextPath}/admin/news-management"
